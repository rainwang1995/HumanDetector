...
void MPLDPK::cal_params()
{
	...
	parts.clear();
	parts.push_back(Rect(0, 0, winSize.width, winSize.height / 4));//head-shoulder
	parts.push_back(Rect(0, winSize.height / 5, winSize.width / 2, winSize.height * 2 / 5));//left-body
	parts.push_back(Rect(winSize.width / 2, winSize.height / 5, winSize.width / 2, winSize.height * 2 / 5));//right-body
	parts.push_back(Rect(0, winSize.height * 3 / 5, winSize.width, winSize.height * 2 / 5));
}
