...
class PLDPK :public DetectionAlgorithm
{
public:
	PLDPK() :featurelenblock(56) { setDefaultParams(); cal_params(); }
	PLDPK(cv::Size _winSize, int _plevels=3,int _k = 3) :featurelenblock(56), winSize(_winSize), K(_k),plevels(_plevels)
	{
		cal_params();
	}
