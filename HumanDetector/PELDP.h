...
class PELDP :public DetectionAlgorithm
{
public:
	PELDP() :featurelenblock(56) { setDefaultParams(); cal_params(); }
	PELDP(cv::Size _winSize, int _plevels = 3) :featurelenblock(56), winSize(_winSize), plevels(_plevels)
	{
		cal_params();
	}
